...
class ApplicationSecurityArchitectAgent:
    """
    Unknown Role - Functional agent with 16 tools
    """

    def __init__(self):
        self.agent_id = "agent_000"
...
# Agent instance
agent_000_agent = ApplicationSecurityArchitectAgent()

# Export tools for Google ADK integration
__all__ = [
    'ApplicationSecurityArchitectAgent',
    'agent_000_agent',
    'SYSTEM_PROMPT',
    'lookup_board_meeting',
    'query_executive_dashboard',
