...
class NetSuiteIntegrationSpecialistAgent:
    """
    Unknown Role - Functional agent with 16 tools
    """

    def __init__(self):
        self.agent_id = "agent_447"
...
# Agent instance
agent_447_agent = NetSuiteIntegrationSpecialistAgent()

# Export tools for Google ADK integration
__all__ = [
    'NetSuiteIntegrationSpecialistAgent',
    'agent_447_agent',
    'SYSTEM_PROMPT',
    'lookup_board_meeting',
    'query_executive_dashboard',
